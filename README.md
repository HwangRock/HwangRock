...
다른 사람들과의 소통을 통해 서로 가진 경험과 지식을 공유하며 안목을 넓히서 문제를 인식하려고 노력하고,<br> 여려가지 기술을 공부함으로써 문제를 해결해서 가치를 창출하기 위해 노력합니다.
</span>
...
효율적인 비즈니스 로직을 위해 알고리즘을 공부하고, 안정적이고 빠른 서버를 위해서 CS에 대해 공부하고, 안전한 데이터 처리를 위해 암호학을 공부하고 있습니다.<br><br>
